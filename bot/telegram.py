...
1. **Изучи каждую новость** — используй web search чтобы найти подробности:
   - Ищи по названию проекта/события чтобы понять контекст
   - Если информации мало — так и напиши, не выдумывай
